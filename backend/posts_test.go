...
func TestGetPost(t *testing.T) {
	...
	if resp["title"] != "Sofa for sale!" {
		t.Errorf("Posts is invalid, expected \"Sofa for sale\", got %v", resp["username"])
	}
}
...
func TestCreatePost(t *testing.T) {
	...
	if resp["title"] != "Hello Kitty Chair for Rent!" {
		t.Errorf("Post title is invalid, expected \"Hello Kitty Chair for Rent!\", got %v", resp["username"])
	}
...
func TestUpdatePost(t *testing.T) {
	...
	if resp["title"] != "Selling a Dining Table" {
		t.Errorf("Post Title is invalid, expected \"Selling a Dining Table\", got %v", resp["username"])
	}
