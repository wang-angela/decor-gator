...
In order to run this program, you must have GO installed. There is a backend.exe file in the backend file. Before running the application, run this executable in a terminal using the command `go build .` within the backend directory of the project to start the server locally.
